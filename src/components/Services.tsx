...
const services = [
  {
    ...
    description: 'React, Next.js, UI/UX - Beautiful, responsive interfaces that users love.',
  },
  {
    icon: Server,
    title: 'Backend Development',
    description: 'APIs, Databases, Microservices - Robust, scalable server-side solutions.',
  },
  {
    icon: TrendingUp,
    title: 'SEO & Performance Optimization',
    description: 'Boost rankings and speed with technical SEO and optimization strategies.',
  },
  {
    icon: Cloud,
    title: 'SaaS Development',
    description: 'End-to-end SaaS platforms with subscription management and scalability.',
  },
  {
    icon: Sparkles,
    title: 'AI & Automation Solutions',
    description: 'Leverage AI and machine learning to automate and enhance workflows.',
  },
  {
    icon: Settings,
    title: 'Cloud & DevOps',
    description: 'AWS, CI/CD pipelines - Reliable infrastructure and deployment systems.',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            From idea to launch and beyond, we build reliable, high-performance digital products.
          </p>
        </div>
